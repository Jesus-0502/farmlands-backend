...
CREATE TABLE IF NOT EXISTS action_plans (
    ...
    id_farm_task INTEGER NOT NULL,
    action_description TEXT,
    fecha_inicio TEXT,
    fecha_cierre TEXT, 
    cantidad_horas TEXT,
    id_responsable INTEGER,
    tiempo_recurso_humano REAL,
    cantidad_de_dias TEXT,
    monto_recurso_humano REAL,
    categoria_insumo_material TEXT,
    descripcion_insumo_material TEXT,
    cantitad_insumo_material INTEGER, 
    id_medida INTEGER, 
    monto_insumo_material REAL,
    monto_total REAL GENERATED ALWAYS AS (monto_recurso_humano + monto_insumo_material),
